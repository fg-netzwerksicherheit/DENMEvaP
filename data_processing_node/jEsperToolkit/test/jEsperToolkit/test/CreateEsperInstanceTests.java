...
/**
 * 
 * First, simple tests for creating Esper instances.
 * 
 * @author Ruediger Gad
 *
 */
public class CreateEsperInstanceTests {

    @Test
    public void instantiateEsperRuntime() {
    ...
    @Test
    public void testCreateEsperRuntimeFacade() {
        EsperRuntimeFacade erf = new EsperRuntimeFacade();
        assertNotNull(erf);
        erf.destroy();
        assertTrue(erf.isDestroyed());
    }
