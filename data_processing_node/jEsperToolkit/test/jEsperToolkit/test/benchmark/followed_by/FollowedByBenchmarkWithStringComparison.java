...
public class FollowedByBenchmarkWithStringComparison extends TimedBenchmark {
	@BeforeClass
	public static void setupClass() {
		for (int i = 1; i <= 10000; i++) {
			Map<String, Object> eventA = new HashMap<String, Object>();
			eventA.put("x", i);
			eventA.put("xString", "StringFoo" + String.valueOf(i));
			...
			eventB.put("y", i);
			eventB.put("yString", "StringFoo" + String.valueOf(i));
	...
	public void setup() {
		...
		String bFollowsAPattern = "INSERT INTO BFollowsA SELECT * FROM PATTERN [ EVERY a = A -> b = B(yString = a.xString) ]";
