 ...
 *
 */
public class SnifferIcmpPingBenchmark extends TimedBenchmark {

    @BeforeClass
    public static void setupClass() {
    	@SuppressWarnings("unchecked")
		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractNestedMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/icmp_ping_office_11-04-2013.pcap");
        for (int i = 0; i < 15; i++) {
            events.addAll(data);
        }
    }
    ...
    public void setup() {
        ...
        prepareBenchmark("sniffer.header.parsed", "feature.icmp.ping.reply.time");
    }
