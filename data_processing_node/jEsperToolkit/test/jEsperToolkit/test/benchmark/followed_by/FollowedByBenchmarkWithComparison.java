...
public class FollowedByBenchmarkWithComparison extends TimedBenchmark {
	@BeforeClass
	public static void setupClass() {
		for (int i = 1; i <= 10000; i++) {
			...
			eventB.put("y", i);
			eventB.put("yString", String.valueOf(i));
	...
	public void setup() {
		...
		String bFollowsAPattern = "INSERT INTO BFollowsA SELECT * FROM PATTERN [ EVERY a = A -> b = B(y = a.x) ]";
