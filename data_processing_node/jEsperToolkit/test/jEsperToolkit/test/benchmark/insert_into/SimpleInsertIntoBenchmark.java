...
public class SimpleInsertIntoBenchmark extends TimedBenchmark {
    ...
    public void setup() {
		...
		erf.createStatement("INSERT INTO B SELECT * FROM A");
		erf.createStatement("INSERT INTO C SELECT * FROM B");
		erf.createStatement("INSERT INTO D SELECT * FROM C");
