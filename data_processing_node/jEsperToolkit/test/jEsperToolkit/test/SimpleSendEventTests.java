...
/**
 * 
 * Test if we can actually send events.
 * 
 * @author Ruediger Gad
 *
 */
public class SimpleSendEventTests extends TestWithEsperRuntimeFacade {

    @Test
    public void sendSimplePojoEvent() {
        SimplePojoEvent evt = new SimplePojoEvent(1, "two");
        erf.send(evt);
    }

    @Test
    public void addSimplePojoEventPattern() {
    ...
    @Test
    public void testTriggerSimplePojoEventPattern() throws InterruptedException {
        erf.addEventType(SimplePojoEvent.class);
