...
/**
 * Base class for tests that utilize the {@link EsperRuntimeFacade}. Please note
 * that subclasses must call super.foo() in the first place of the overriding
 * method when they override either setup or tearDown with foo being the name of
 * the overridden method.
 * 
 * @author Ruediger Gad
 * 
 */
public class TestWithEsperRuntimeFacade {

    protected EsperRuntimeFacade erf;
    protected boolean wasRun;

    @Before
    public void setup() {
        erf = new EsperRuntimeFacade();
        wasRun = false;
    }
