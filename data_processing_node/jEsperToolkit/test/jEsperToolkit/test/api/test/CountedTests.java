 ...
 *
 */
public class CountedTests extends TestWithCounter {
	...
	public void testCount() throws InterruptedException {
		assertEquals(0, getSuccessfullyProcessedEventsCount()[0]);
		assertEquals(0, getSuccessfullyProcessedEventsCount("A"));
		
		sendEvents();
		Thread.sleep(400);

		assertEquals(5, getSuccessfullyProcessedEventsCount()[0]);
		assertEquals(5, getSuccessfullyProcessedEventsCount("A"));
	}
}
