...
package jEsperToolkit.test.api.test;
 ...
 *
 */
public class FixedRateTests extends TestWithFixedEventSendRate{
	...
	public void setup() {
        ...
        setCountedEventTypes("A");		
	}
	
	@Test
	public void testFixedRateRun() throws InterruptedException {
        assertEquals(0, getSuccessfullyProcessedEventsCount("A"));
        sendEventsWithRate(1000);
        Thread.sleep(125);
        stopSendingEvents();
        
        assertTrue(getSuccessfullyProcessedEventsCount("A") > 100);
	}
	
	@Test
	public void testFixedRateHighFrequencyRun() throws InterruptedException {
        assertEquals(0, getSuccessfullyProcessedEventsCount("A"));
        sendEventsWithRate(100000);
        Thread.sleep(1250);
        stopSendingEvents();
        
        assertTrue(getSuccessfullyProcessedEventsCount("A") > 10000);
	}
	...
	public static void main(String args[]) {
		...
		FixedRateTests test = new FixedRateTests();
		test.setup();
