...
public class TcpConnectionEstablishedFixedRateTests extends TestWithFixedEventSendRate {
	...
	public void setup() {
		...
		currentIndex = 0;
		List<PacketHeaderDataBean> data = CljNetPcapJavaAdapter.extractMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/200604101400_split2_00001_20060410070145");
//		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/combined_office_22-04-2013.pcap");
        ...
        erf.addEventType("sniffer.header.parsed.flat", JavaTools.getFlatMapSample());
        ...
        setCountedEventTypes("sniffer.header.parsed.flat", "cep.tcp.connection.established");
