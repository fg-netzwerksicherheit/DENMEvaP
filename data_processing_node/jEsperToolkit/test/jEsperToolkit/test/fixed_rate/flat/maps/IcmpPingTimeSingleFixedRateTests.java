 ...
 * 
 */
public class IcmpPingTimeSingleFixedRateTests extends TestWithFixedEventSendRate {
	...
	public void setup() {
        ...
        erf.addEventType("sniffer.header.parsed.flat", (Map<String, Object>) events.get(491));
...
"]");
        ...
        setCountedEventTypes("sniffer.header.parsed.flat", "cep.icmp.ping.response.time");
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		IcmpPingTimeSingleFixedRateTests test = new IcmpPingTimeSingleFixedRateTests();
	...
	private static void printEventStats(IcmpPingTimeSingleFixedRateTests test) throws FileNotFoundException {
