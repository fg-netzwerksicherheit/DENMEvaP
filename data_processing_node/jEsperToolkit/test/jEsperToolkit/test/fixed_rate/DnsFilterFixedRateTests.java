...
//		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractNestedMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/combined_office_22-04-2013.pcap");
        ...
        erf.createStatement("INSERT INTO cep.dns SELECT * FROM sniffer.header.parsed WHERE Udp.source = 53 OR Udp.destination = 53");
        
        setCountedEventTypes("sniffer.header.parsed", "cep.dns");
	...
	public void testFixedRateRun() throws InterruptedException {
		...
		assertTrue(getSuccessfullyProcessedEventsCount("sniffer.header.parsed") > 10);
	}
