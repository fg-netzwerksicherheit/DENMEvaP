...
public class UdpFilterFixedRateTests extends TestWithFixedEventSendRate {
	...
	public void setup() {
        ...
        erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(490));
        
        erf.createStatement("INSERT INTO cep.udp SELECT * FROM sniffer.header.parsed WHERE Udp is not null");
        
        setCountedEventTypes("sniffer.header.parsed", "cep.udp");
