 ...
 * 
 */
public class UdpResponseTimeEveryDistinctTests extends TestWithFixedEventSendRate {
...
//		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractNestedMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/dns_requests_office_17-04-2013.pcap");
		for (int i = 0; i < 6; i++) {
			events.addAll(data);
		}

		erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(70));
//		erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(178));
        ...
        erf.createStatement(
        		...
        		"FROM PATTERN [ " +
        		  "EVERY-DISTINCT(a.Udp.source, a.Udp.destination, a.NetworkLayer.source, a.NetworkLayer.destination, 3 seconds) " +
		...
		setCountedEventTypes("sniffer.header.parsed", "feature.dns.reply.time");
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		UdpResponseTimeEveryDistinctTests test = new UdpResponseTimeEveryDistinctTests();
	...
	private static void printEventStats(UdpResponseTimeEveryDistinctTests test) throws FileNotFoundException {
