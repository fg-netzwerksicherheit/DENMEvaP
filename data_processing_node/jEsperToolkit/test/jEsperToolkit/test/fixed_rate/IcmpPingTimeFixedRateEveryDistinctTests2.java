 ...
 * 
 */
public class IcmpPingTimeFixedRateEveryDistinctTests2 extends TestWithFixedEventSendRate {
...
//		erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(7));
        ...
        erf.createStatement(
        		...
        		"FROM PATTERN [ " +
        		  "EVERY-DISTINCT(a.NetworkLayer.source, a.NetworkLayer.destination, 3 seconds) " +
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		IcmpPingTimeFixedRateEveryDistinctTests2 test = new IcmpPingTimeFixedRateEveryDistinctTests2();
	...
	private static void printEventStats(IcmpPingTimeFixedRateEveryDistinctTests2 test) throws FileNotFoundException {
