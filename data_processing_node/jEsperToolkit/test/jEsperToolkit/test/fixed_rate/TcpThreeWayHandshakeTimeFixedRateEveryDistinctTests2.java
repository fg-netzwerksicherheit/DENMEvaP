 ...
 * 
 */
public class TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2 extends TestWithFixedEventSendRate {
	...
	public void setup() {
		...
		currentIndex = 0;
		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractNestedMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/combined_data_set_office_19-04-2013.pcap");
//		List<Map<?, ?>> data = CljNetPcapJavaAdapter.extractNestedMapsFromPcapFile("test/jEsperToolkit/test/benchmark/test_data/http_wget_office_17-04-2013.pcap");
        for (int i = 0; i < 15; i++) {
            events.addAll(data);
        }
  ...
  "(synTimestamp, ackTimestamp, time, source, destination, sourcePort, destinationPort, requestTtl) " +
"SELECT " +
  ...
  "a.NetworkLayer.ttl " +
"FROM PATTERN [ " +
  "EVERY-DISTINCT(a.Tcp.destination, a.NetworkLayer.source, 1 seconds) " +
...
"]");
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2 test = new TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2();
	...
	private static void printEventStats(TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2 test) throws FileNotFoundException {
