 ...
 * 
 */
public class ArpFilterFixedRateTests extends TestWithFixedEventSendRate {
	...
	public void setup() {
        ...
        erf.createStatement("INSERT INTO cep.arp SELECT * FROM sniffer.header.parsed WHERE Arp is not null");
        
        setCountedEventTypes("sniffer.header.parsed", "cep.arp");
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		ArpFilterFixedRateTests test = new ArpFilterFixedRateTests();
	...
	private static void printEventStats(ArpFilterFixedRateTests test) throws FileNotFoundException {
