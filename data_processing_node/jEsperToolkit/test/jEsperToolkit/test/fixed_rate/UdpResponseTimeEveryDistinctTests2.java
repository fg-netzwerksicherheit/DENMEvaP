 ...
 * 
 */
public class UdpResponseTimeEveryDistinctTests2 extends TestWithFixedEventSendRate {
...
//		erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(178));
        ...
        erf.createStatement(
        		...
        		"FROM PATTERN [ " +
        		  "EVERY-DISTINCT(a.Udp.destination, a.NetworkLayer.source, a.NetworkLayer.destination, 3 seconds) " +
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		UdpResponseTimeEveryDistinctTests2 test = new UdpResponseTimeEveryDistinctTests2();
	...
	private static void printEventStats(UdpResponseTimeEveryDistinctTests2 test) throws FileNotFoundException {
