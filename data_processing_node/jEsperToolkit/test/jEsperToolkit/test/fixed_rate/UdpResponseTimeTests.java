 ...
 * 
 */
public class UdpResponseTimeTests extends TestWithFixedEventSendRate {
...
//		erf.addEventType("sniffer.header.parsed", (Map<String, Object>) events.get(178));
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		UdpResponseTimeTests test = new UdpResponseTimeTests();
	...
	private static void printEventStats(UdpResponseTimeTests test) throws FileNotFoundException {
