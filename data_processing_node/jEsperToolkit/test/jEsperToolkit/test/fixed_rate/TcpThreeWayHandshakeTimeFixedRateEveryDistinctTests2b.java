 ...
 * 
 */
public class TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2b extends TestWithFixedEventSendRate {
...
"SELECT " +
  ...
  "a.NetworkLayer.ttl " +
"FROM PATTERN [ " +
  "EVERY-DISTINCT(Tcp.destination, NetworkLayer.source, NetworkLayer.destination, 3 seconds) " +
...
"]");
	...
	public static void main(String args[]) throws UnsupportedEncodingException,
		...
		TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2b test = new TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2b();
	...
	private static void printEventStats(TcpThreeWayHandshakeTimeFixedRateEveryDistinctTests2b test) throws FileNotFoundException {
