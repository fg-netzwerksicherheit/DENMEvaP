...
package jEsperToolkit.test.insert_into;
 ...
 * 
 */
public class SimpleInsertIntoTest extends TestWithEsperRuntimeFacade {
	@Test
	public void testFollowedBy() throws InterruptedException {
		...
		EPStatement stmt = erf.createStatement("SELECT * FROM D");
