...
(ns 
  ^{:author "Ruediger Gad",
   ...
   cljEsperRunner.test.count-brute-force-flood-conntrack-events
  (:use clojure.test
  ...
  (:require (clojure [string :as str])
            ...
            (cljEsperRunner.test.data.conntrack [ssh-brute-force-sshpass-wlan0-2012-11-26 :as sample-01]
                                                [ssh-brute-force-sshpass-em1-2012-12-06 :as sample-02]
                                                [ssh-brute-force-sshpass-em1-2-2012-12-06 :as sample-03])))
...
(let [events sample-01/data-set
      ...
      cnt-est (counted-statement sp simple-patterns/tcp-connection-established-conntrack)
      cnt-fin (counted-statement sp simple-patterns/tcp-connection-finished-conntrack)
      cnt-dur (counted-statement sp simple-patterns/tcp-connection-duration-conntrack-2)
      cnt-ssh-dur (counted-statement sp brute-force-patterns/ssh-connection-duration-conntrack)
      cnt-ssh-short (counted-statement sp brute-force-patterns/ssh-connection-short-conntrack)
      cnt-ssh-bf (counted-statement sp brute-force-patterns/ssh-simple-bruteforce-conntrack)
