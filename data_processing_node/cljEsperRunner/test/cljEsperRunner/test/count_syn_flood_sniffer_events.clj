...
(ns 
  ^{:author "Ruediger Gad",
   ...
   cljEsperRunner.test.count-syn-flood-sniffer-events
  (:use clojure.test
        clj-assorted-utils.util
        cljEsperRunner.esper)
  (:require (clojure [string :as str])
            (cljEsperRunner.patterns [simple-sniffer :as simple-patterns]
                                     [sniffer-syn-flood :as syn-patterns])
            (cljEsperRunner.test.data.sniffer [syn-flood-sender-rand-2012-11-07 :as rand-01]
...
(deftest count-syn-dos-without-connection-rand-01
  (let [events rand-01/data-set
        ...
        cnt-tcp-est (counted-statement sp simple-patterns/tcp-connection-established)
        cnt-tcp-syn (counted-statement sp simple-patterns/tcp-syn-sent)
        cnt-tcp-wo-syn (counted-statement sp syn-patterns/tcp-syn-without-connection)
        cnt-tcp-syn-flood (counted-statement sp syn-patterns/tcp-syn-flood-without-connection)
        cnt-dos (counted-statement sp syn-patterns/tcp-syn-dos-without-connection)]
...
(deftest count-syn-dos-rand-01
  (let [events rand-01/data-set
        ...
        cnt-all (counted-statement sp "select * from sniffer.header.parsed")
        cnt-tcp-syn (counted-statement sp simple-patterns/tcp-syn-sent)
        cnt-syn-flood (counted-statement sp syn-patterns/tcp-syn-flood)
        cnt-dos (counted-statement sp syn-patterns/tcp-syn-dos)]
    ((create-send-fn sp) events)
    (sleep 1000)
