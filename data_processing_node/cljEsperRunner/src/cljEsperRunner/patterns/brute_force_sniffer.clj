...
(ns
  ...
  cljEsperRunner.patterns.brute-force-sniffer
  (:use cljEsperRunner.esper))

;;; For now we just look at the port number...
(def-epl-pattern ssh-connection-duration
  "
INSERT INTO
...
(def short-ssh-connection-threshold 5000000000)
(def-epl-pattern ssh-connection-short
  (str
  "
INSERT INTO
...
(def-epl-pattern ssh-simple-bruteforce
  (str
  "
INSERT INTO
